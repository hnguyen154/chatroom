...
<body>
  <br />
  <h3 align="center">Welcome to CSC4350 Chatroom</h3>
  <br />
  ...
  <div ng-app="login_register_app" ng-controller="login_register_controller" class="container form_style">
    ...
    if(!isset($_SESSION["name"]))
    {
        ...
        <div class="panel-body">
          <form method="post" ng-submit="submitLogin()">
            ...
            <div class="form-group" align="center">
              ...
              <input type="button" name="forgot_link" class="btn btn-primary btn-link" ng-click="showForgot()" value="Forgot the Password?" />
            </div>
          </form>
        </div>
      </div>
        ...
        <div class="panel-body">
          <form method="post" ng-submit="submitRegister()">
            ...
            <div class="form-group">
              ...
              <input type="text" name="question" ng-model="registerData.question" class="form-control" />
            </div>
            <div class="form-group">
              <label>Enter an Answer</label>
              <input type="text" name="answer" ng-model="registerData.answer" class="form-control" />
            </div>
            <div class="form-group" align="center">
      ...
      <div class="panel panel-default" ng-show="forgot_form">
        <div class="panel-heading">
          <h3 class="panel-title">Forgot Your Password</h3>
        </div>
        <div class="panel-body">
          <form method="post" ng-submit="submitForgot()">
            <div class="form-group">
              <label>Enter Email</label>
              <input type="text" name="email" ng-model="forgotData.email" class="form-control" />
            </div>
            <div class="form-group">
              <label>Enter Your Queston</label>
              <input type="text" name="question" ng-model="forgotData.question" class="form-control" />
            </div>
            <div class="form-group">
              <label>Enter Your Answer</label>
              <input type="text" name="answer" ng-model="forgotData.answer" class="form-control" />
            </div>
            <div class="form-group" align="center">
